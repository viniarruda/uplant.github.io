...
(function(e) {
    ...
    e.fn.mdSlider = function(r) {
        function A() {
            ...
            h = [];
            a = W();
            if (a) o.addClass("md-touchdevice");
            ...
            e(".md-object", s).hide();
            if (e(".md-video", o).size() > 0) {
                if (r.videoBox) {
                    e(".md-video", o).mdvideobox()
                } else {
                    var n = e('<div class="md-video-control" style="display: none"></div>');
                    o.append(n);
                    e(".md-video", o).click(function() {
        ...
        function O() {
            if (r.slideShow && r.showLoading) {
                var t = e('<div class="loading-bar-hoz loading-bar-' + r.loadingPosition + '"><div class="br-timer-glow" style="left: 120px;"></div><div class="br-timer-bar" style="width:220px"></div></div>');
                o.append(t);
                g = e(".br-timer-bar", t);
                y = e(".br-timer-glow", t)
            }
            ...
            if (r.showArrow) {
                v = e('<div class="md-arrow" style="opacity:0;"><div class="md-arrow-left"><span></span></div><div class="md-arrow-right"><span></span></div></div>');
                u.append(v);
                e(".md-arrow-right", v).bind("click", function() {
                    F()
                });
                e(".md-arrow-left", v).bind("click", function() {
                    I()
                })
            }
            if (r.showBullet != false) {
                m = e('<div class="md-bullets"></div>');
                o.append(m);
                for (var a = 0; a < f; a++) {
                    m.append('<div class="md-bullet"  rel="' + a + '"><a></a></div>')
                }
                if (r.showThumb) {
                    var l = parseInt(s.data("thumb-width")),
                        c = parseInt(s.data("thumb-height"));
                    for (var a = 0; a < f; a++) {
                        var p = h[a].data("thumb");
                        if (p) {
                            var d = e("<img />").attr("src", p).css({
                                top: -(9 + c) + "px",
                                left: -(l / 2 - 2) + "px",
                                opacity: 0
                            });
                            e("div.md-bullet:eq(" + a + ")", m).append(d).append('<div class="md-thumb-arrow" style="opacity: 0"></div>')
                        }
                    }
                    e("div.md-bullet", m).hover(function() {
                ...
                e("div.md-bullet", o).click(function() {
                ...
                var w = e('<div class="md-thumb"><div class="md-thumb-container"><div class="md-thumb-items"></div></div></div>').appendTo(o);
                b = e(".md-thumb-items", w);
                for (var a = 0; a < f; a++) {
                    var p = h[a].data("thumb");
                    if (p) {
                        var E = e('<a class="md-thumb-item" />').attr("rel", a).append(e("<img />").attr("src", p));
                        b.append(E)
                    }
                }
                e("a", b).click(function() {
                    if (e(this).hasClass("md-current") || x) {
                        return false
                    }
                    var t = e(this).attr("rel");
                    H(t)
        ...
        function M() {
            if (a) {
                s.bind("touchstart", function(e) {
                    ...
                    if (!E) {
                        E = true;
                        if (r.transitions == "scrollVert" || r.transitions == "scrollUp" || r.transitions == "scrollDown") this.mouseY = e.pageY;
                        else this.mouseX = e.pageX
                    }
                });
                s.bind("touchmove", function(e) {
                    e = e.originalEvent.touches[0] || e.originalEvent.changedTouches[0];
                    if (E) {
                        if (r.transitions == "scrollVert" || r.transitions == "scrollUp" || r.transitions == "scrollDown") S = e.pageY - this.mouseY;
                        else S = e.pageX - this.mouseX
                    }
                    return false
                });
                s.bind("touchend", function(e) {
                    E = false;
                    if (S > r.touchSensitive) {
                        I();
                        S = 0;
                        return false
                    } else if (S < -r.touchSensitive) {
                        F();
                        S = 0;
                        return false
                    }
                ...
                if (t > e(".md-thumb-container", n).width()) {
                    ...
                    if (a) {
                        ...
                        b.bind("touchmove", function(e) {
                            ...
                            e = e.originalEvent.touches[0] || e.originalEvent.changedTouches[0];
                            if (i) {
                                b.css("left", s + e.pageX - this.mouseX)
                            }
                            return false
                        });
                        b.bind("touchend", function(t) {
                            t.preventDefault();
        ...
        function D(t) {
            if (b) {
                if (t == "left") {
                    var n = b.position().left;
                    if (n > w) {
                        var r = e(".md-thumb-container", o).width();
                        if (n - r > w) {
                            b.stop(true, true).animate({
                                left: n - r
                            }, 400, function() {
                    ...
                    var i = e("a", b).index(e("a.md-current", b));
                    if (i >= 0) {
                        var n = b.position().left;
                        var s = i * e("a", b).width();
                        if (s + n < 0) {
        ...
        function P() {
            var t = b.position().left;
            if (t > w) {
                e(".md-thumb-next", o).show()
            } else {
                e(".md-thumb-next", o).hide()
            }
            if (t < 0) {
                e(".md-thumb-prev", o).show()
            } else {
                e(".md-thumb-prev", o).hide()
            }
        }
        ...
        function H(t, n) {
            ...
            if (t != p) {
                ...
                var o = z(r.transitions, n);
                if (o) {
                    r.onStartTransition.call(s);
                    if (h[d]) {
                        e("div.md-bullet:eq(" + d + ")", m).removeClass("md-current");
                        e("a:eq(" + d + ")", b).removeClass("md-current");
                        R(h[d]);
                        h[d].animate(o.oSlide, r.transitionsSpeed, function() {
                            h[d].hide()
                        });
                        T = h[t].data("timeout") ? h[t].data("timeout") : r.slideShowDelay;
                        h[t].css(o.newSlide.before).show();
                        h[t].animate(o.newSlide.after, r.transitionsSpeed, function() {
                            r.onEndTransition.call(s)
                        })
                    } else {
                        T = h[t].data("timeout") ? h[t].data("timeout") : r.slideShowDelay;
                        h[t].css(o.newSlide.after).show()
                    }
                    if (m) e("div.md-bullet:eq(" + t + ")", m).addClass("md-current");
                    if (b) e("a:eq(" + t + ")", b).addClass("md-current");
                    U(h[t]);
                    D();
                    p = t
                }
        ...
        function U(n) {
            n.find(".md-object").each(function(n) {
                var r = e(this);
                ...
                if (r.data("stop") != undefined) {
                    if (f == 1 && r.data("stop") == T && r.data("easeout") == null) return;
        ...
        function z(e, t) {
            ...
            } else if (e == "scrollHorz") {
                if (t) return z("scrollLeft");
                else return z("scrollRight")
            } else if (e == "scrollUp") {
                return {
                    oSlide: {
                        left: 0,
            ...
            } else if (e == "scrollVert") {
                if (t) return z("scrollUp");
                else return z("scrollDown")
            } else if (e == "fade") {
                return {
                    oSlide: {
                        left: 0,
        ...
        function X() {
            o.width();
            l = r.responsive ? o.width() : r.width;
            if (r.responsive && l < r.width) {
                c = Math.round(l / r.width * r.height)
            } else {
                c = r.height
            }
            if (!r.responsive && !r.fullwidth) o.width(l);
            if (!r.responsive && r.fullwidth) o.css({
                "min-width": l + "px"
            });
            if (r.fullwidth) {
                e(".md-objects", s).width(r.width);
                var t = 20;
                if ((o.width() - r.width) / 2 > 20) t = (o.width() - r.width) / 2;
                o.find(".md-bullets").css({
                    left: t,
                    right: t
                });
                o.find(".md-thumb").css({
            ...
            if (r.responsive && r.fullwidth && o.width() < r.width) e(".md-objects", s).width(l);
            o.height(c);
        ...
        function G() {
            ...
            if (o.width() < r.width) {
                e(".md-objects", s).css({
                    "font-size": o.width() / r.width * 100 - t + "%"
                })
            } else {
                e(".md-objects", s).css({
                    "font-size": 100 - t + "%"
        ...
        function Y() {
            if (o.width() < r.width && r.responsive) {
                ...
                e(".md-objects > div", s).each(function() {
                    var t = e(this),
                        n = [];
                    if (t.data("padding-top")) {
                        n["padding-top"] = t.data("padding-top")
                    }
        ...
        var i = {
            ...
            transitions: "scrollHorz",
            transitionsSpeed: 600,
            width: 990,
            height: 420,
            responsive: true,
            fullwidth: true,
